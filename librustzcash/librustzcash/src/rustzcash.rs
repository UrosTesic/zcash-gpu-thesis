...
pub extern "system" fn librustzcash_sapling_output_proof(
    ...
    let end_witness = now_witness.elapsed();
    println!("Output proof witness generation takes {}_{} microseconds.", end_witness.as_secs(), end_witness.subsec_micros());
...
#[no_mangle]
pub extern "system" fn librustzcash_run_tests() {
	bellman::multiexp::run_tests();
}
...
pub extern "system" fn librustzcash_sapling_spend_proof(
    ...
    let end_witness = now_witness.elapsed();
    println!("Spending proof witness generation takes {}_{} microseconds.", end_witness.as_secs(), end_witness.subsec_micros());
